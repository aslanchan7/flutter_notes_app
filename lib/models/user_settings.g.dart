...
const UserSettingsSchema = CollectionSchema(
  ...
  properties: {
    r'isNotesGridView': PropertySchema(
      id: 0,
      name: r'isNotesGridView',
      type: IsarType.bool,
    )
  },
...
void _userSettingsSerialize(
  ...
  writer.writeBool(offsets[0], object.isNotesGridView);
}
...
UserSettings _userSettingsDeserialize(
  ...
  object.id = id;
  object.isNotesGridView = reader.readBool(offsets[0]);
  return object;
}
...
extension UserSettingsQueryFilter
  ...
  QueryBuilder<UserSettings, UserSettings, QAfterFilterCondition>
      isNotesGridViewEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isNotesGridView',
        value: value,
      ));
    });
  }
...
extension UserSettingsQuerySortBy
  ...
  QueryBuilder<UserSettings, UserSettings, QAfterSortBy>
      sortByIsNotesGridView() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isNotesGridView', Sort.asc);
    });
  }

  QueryBuilder<UserSettings, UserSettings, QAfterSortBy>
      sortByIsNotesGridViewDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isNotesGridView', Sort.desc);
    });
  }
}
...
extension UserSettingsQueryWhereDistinct
  ...
  QueryBuilder<UserSettings, UserSettings, QDistinct>
      distinctByIsNotesGridView() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isNotesGridView');
    });
  }
}
...
extension UserSettingsQueryProperty
  ...
  QueryBuilder<UserSettings, bool, QQueryOperations> isNotesGridViewProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isNotesGridView');
    });
  }
}
